...
{
    [DbContext(typeof(DB))]
    [Migration("20250802223114_ChangeNullableColumn")]
    partial class ChangeNullableColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sports.Model.MatchesReports", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("GoalsReportsId")
                        .HasColumnType("int");

                    b.Property<int?>("MatchId")
                        .HasColumnType("int");

                    b.Property<int?>("PlayersReportsId")
                        .HasColumnType("int");

                    b.Property<int?>("Tech_AdminReportsId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CardsReportsId");

                    b.HasIndex("GoalsReportsId");

                    b.HasIndex("MatchId");

                    b.HasIndex("PlayersReportsId");

                    b.HasIndex("Tech_AdminReportsId");

                    b.ToTable("matchesReports");
                });
            ...
            modelBuilder.Entity("Sports.Model.MatchesReports", b =>
                {
                    ...
                    b.HasOne("Sports.Model.CardsReports", "CardsReports")
                        .WithMany()
                        .HasForeignKey("CardsReportsId");

                    b.HasOne("Sports.Model.GoalsReports", "GoalsReports")
                        .WithMany()
                        .HasForeignKey("GoalsReportsId");

                    b.HasOne("Sports.Model.Match", "Match")
                        .WithMany()
                        .HasForeignKey("MatchId");

                    b.HasOne("Sports.Model.PlayersReport", "PlayersReport")
                        .WithMany()
                        .HasForeignKey("PlayersReportsId");

                    b.HasOne("Sports.Model.Tech_AdminReports", "TechAdminReports")
                        .WithMany()
                        .HasForeignKey("Tech_AdminReportsId");
                    ...
                    b.Navigation("PlayersReport");

                    b.Navigation("TechAdminReports");
                });
